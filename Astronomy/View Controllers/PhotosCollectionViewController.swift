...
class PhotosCollectionViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    private func loadImage(forCell cell: ImageCollectionViewCell, forItemAt indexPath: IndexPath) {
        ...
        if let cachedImage = cache.value(for: photoReference.id) {
            cell.imageView.image = cachedImage // This should already be filterd now.
            return
        }
        ...
        // lets make a filter op
        let filterOp = FilterPhotoOperation(fetchPhotoOp: fetchOp)
        ...
        let completionOp = BlockOperation {
            ...
            if let image = filterOp.image {
                cell.imageView.image = image // This is the filtered image
            }
        }
